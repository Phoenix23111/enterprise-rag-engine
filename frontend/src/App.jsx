...
function App() {
  ...
  return (
    <div style={{ backgroundImage: `url(${backgroundImg})` }} className={`chat-container flex flex-col justify-center items-center gap-4 p-4 lg:px-60 sm:px-20 w-full  min-h-screen  bg-cover  `}>
